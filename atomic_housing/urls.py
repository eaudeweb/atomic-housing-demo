...
urlpatterns = patterns(
    ...
    url(r'^hsadmin/customer/(?P<pk>.*)/detail', views.HSAdminCustomerDetail.as_view(),
    ...
    url(r'^hsadmin/reports/', views.HSReport.as_view(),
        name='hsadmin_reports'),

    url(r'^landlord/listings$',
        views.LandLordListings.as_view(),
        name='listings'),
    url(r'^landlord/listings/add$',
        views.LandLordListingsAdd.as_view(),
        name='listings_add'),
    url(r'^landlord/listings/(?P<pk>.*)/edit$',
        views.LandLordListingsEdit.as_view(),
        name='listings_edit'),
    url(r'^landlord/listings/(?P<pk>.*)/photos$',
        views.LandLordListingsPhotosEdit.as_view(),
        name='listings_photos'),
    url(r'^landlord/listings/(?P<pk>.*)/photos/(?P<photo_pk>.*)/delete$',
        views.LandLordListingsPhotoDelete.as_view(),
